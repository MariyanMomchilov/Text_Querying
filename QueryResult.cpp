...
QueryResult::QueryResult(const std::string &_w, const std::vector<std::string> &_text_ref, const SharedPtr<std::set<size_t>> &_set_ptr) noexcept : word(_w), text_ref(_text_ref), set_ptr(_set_ptr) {}
